        ...
        <h2 align="center">DATA CUSTOMER</h2>
            <table style="width:100%" cellspacing="0">
                ...
                <tr class="tengah">
                    ...
                    <td>
                        <center>    
                            <a class="nav-link" href="<?php echo "tambah_fahmi.php"; ?>"><b>Menambah Data</b></a>
                        </center>
                    </td>
                </tr>
                <tr class="akhir">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo "update_customers.php?nrp=".$data['customerNumber']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                                                &nbsp;&nbsp;
