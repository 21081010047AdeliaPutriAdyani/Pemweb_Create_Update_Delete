<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        //query SQL
        $query = "INSERT INTO customers (customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city, state, postalCode, salesRepEmployeeNumber, creditLimit) 
        VALUES('$customerNumber', '$customerName', '$contactLastName', '$contactFirstName', '$phone', '$addressLine1', '$addressLine2', '$city', '$state', '$postalCode', '$salesRepEmployeeNumber', '$creditLimit')"; 
        ...
        <h2 align="center">DATA CUSTOMER</h2>
            <table style="width:100%" cellspacing="0">
                <tr class="atas">
                    <td class="satu">
                        <center>
                            <a class="nav-link active" href="<?php echo "index.php"; ?>"><b>Halaman Awal</b></a>
                        </center>
                    </td>
                    ...
                    <td class="tiga">
                        <center>    
                            <a class="nav-link" href="<?php echo "employees.php"; ?>"><b>data employees</b></a>
                        </center>    
                    </td>
                </tr>
